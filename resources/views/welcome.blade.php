    ...
    <div class="main d-flex flex-column">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand ms-4" href="#">Laravel Auth</a>
                <a class="btn btn-outline-danger me-4 d-flex align-items-center" href="{{ route('logout') }}">
                    <lord-icon
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <dl class="row">
                                    ...
                                    <dd class="col-sm-9 user-info">{{ $user->username }}</dd>
