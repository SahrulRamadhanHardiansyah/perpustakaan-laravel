...
<div class="d-sm-flex justify-content-between align-items-center mb-4">
    <h3 class="text-body-emphasis mb-0">Formulir Peminjaman Buku</h3>
</div>
...
<div class="row">
    <div class="col-md-5">
        <form action="{{ route('proses.pinjam.buku') }}" method="post" id="loan-form">
            @csrf
...
<script>
    $(document).ready(function() {
        ...
        function loadBooks() {
            ...
            $.ajax({
                url: '{{ route("buku.search.public.visual") }}', 
                type: 'GET',
                data: {
                    keyword: keyword,
                    jenis: jenis
